# zybooks 9.2 LAB Nutritional information (classes/constructors).py
# 
...
# 1.0
# 
# where M&M's is the food name, 10.0 is the grams of fat, 34.0 is the grams of carbohydrates, 2.0 is the grams of protein, 
# and 1.0 is the number of servings, the output is:
# 
# 
...
# ================================================================== #
# 
# LAB ACTIVITY 9.2.1: LAB: Nutritional information (classes/constructors)
# 
# main.py 
# 
# class FoodItem:
# TO-DO: Define constructor with parameters to initialize instance 
