# zybooks 9.3 LAB Artwork label (classes, constructors).py
# 
...
# 
# The constructor should by default initialize the title to "None", the year created to 0, and the artist to use 
# the Artist default constructor parameter values.
# 
# Ex: If the input is:
# 
# Pablo Picasso
...
# ================================================================== #
# 
# LAB ACTIVITY 9.3.1: LAB: Artwork label (classes/constructors)
# 
# main.py 
# 
# class Artist:
