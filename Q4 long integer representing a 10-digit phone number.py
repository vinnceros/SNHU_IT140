# Given a long integer representing a 10-digit phone number, output the area code, prefix,
# and line number using the format (800)555-1212. Ex. If the input is: 8005551212. 
