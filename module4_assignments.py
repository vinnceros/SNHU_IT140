# -----------------------------------------------------
# Exercise: Convert an Integer to its Ordinal Number
# -----------------------------------------------------
...
# -----------------------------------------------------
# Exercise: The Twelve Days of Christmas
# -----------------------------------------------------
...
#         for counter in range(ordinal_num_2.index(ordinal),-1, -1): 
# should be the current number's index printing every preceding index in descending order.
